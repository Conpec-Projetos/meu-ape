...
export default function PropertyTable({
    ...
    const [showEditImagesModal, setShowEditImagesModal] = useState<{ open: boolean; id: string | null }>({
        open: false,
        id: null,
    });
    ...
    return (
        <div className="w-full">
            ...
            {showAddModal && <AddUnitModal onClose={() => setShowAddModal(false)} onSave={handleAddUnit} />}
