            ...
            {properties.map((property) => (
              <TableRow key={property.id}>
                ...
                <TableCell>
                  ...
                  <span className="truncate block max-w-[200px] sm:max-w-xs" title={property.address as unknown as string}>
                ...
                <TableCell className="py-4 text-right space-x-2">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button variant="outline" size="icon" className="cursor-pointer" onClick={(e) => { e.stopPropagation(); onEdit(property); }}>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button variant="outline" size="icon" className="cursor-pointer border-red-500 text-red-500 hover:bg-red-500 hover:text-white" onClick={(e) => { e.stopPropagation(); onDelete(property); }}>
