...
export function JustInTimeDataModal({ missingFields, onClose, onSubmit, isOpen }: JustInTimeDataModalProps) {
    ...
    return (
        <div
            className={`fixed inset-0 z-50 flex items-center justify-center bg-black/30 ${isReady ? "block" : "hidden"}`}
        >
            <Card className="p-6 w-full max-w-md">
                ...
                <CardContent className="overflow-y-auto max-h-[400px] p-6">
                    <form className="flex flex-col items-center gap-4 " onSubmit={handleSubmit(handleSubmitForm)}>
                                    ...
                                    return (
                                        <div className="w-full" key={field}>
                                            <div className="space-y-2">
                                                ...
                                                <Input id="cpf" {...register("cpf")} placeholder="XXX.XXX.XXX-XX" />
                                            </div>
                                    ...
                                    return (
                                        <div className="w-full" key={field}>
                                            <div className="space-y-2">
                                                ...
                                                <Input id="address" {...register("address")} placeholder="Rua, Nº" />
                                            </div>
                        ...
                        {/* Document uploads */}
                        <div
                            className={`flex flex-col justify-start mt-4 w-full ${requiredDocs.some(doc => missingFields.includes(doc)) ? "block" : "hidden"}`}
                        >
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex flex-col items-center space-y-1">
                                                            {watch("addressProof")?.[0] &&
                                                                Array.from(watch("addressProof") as FileList).map(
                                                                    (file: File) => (
                                                                        <span
                                                                            key={file.name}
                                                    ...
                                                    <Input
                                                        ...
                                                        {...register("addressProof", {
                                                            onChange: e => {
                                                                ...
                                                                setValue("addressProof", e.target.files, {
                                                                    shouldValidate: true,
                                                                });
                                                            },
                                                        })}
                                            ...
                                            return (
                                                <div key={field}>
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex flex-col items-center space-y-1">
                                                            {watch("incomeProof")?.[0] &&
                                                                Array.from(watch("incomeProof") as FileList).map(
                                                                    (file: File) => (
                                                                        <span
                                                                            key={file.name}
                                                                            className="text-center text-sm"
                                                    ...
                                                    <Input
                                                        ...
                                                        {...register("incomeProof", {
                                                            onChange: e => {
                                                                ...
                                                                // Important: setValue to keep RHF in sync and trigger validation
                                                                setValue("incomeProof", e.target.files, {
                                                                    shouldValidate: true,
                                                                });
                                                            },
                                                        })}
                                            ...
                                            return (
                                                <div key={field}>
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex flex-col items-center space-y-1">
                                                            {watch("identityDoc")?.[0] &&
                                                                Array.from(watch("identityDoc") as FileList).map(
                                                                    (file: File) => (
                                                                        <span
                                                                            key={file.name}
                                                                            className="text-center text-sm"
                                                    ...
                                                    <Input
                                                        ...
                                                        {...register("identityDoc", {
                                                            onChange: e => {
                                                                ...
                                                                // Important: setValue to keep RHF in sync and trigger validation
                                                                setValue("identityDoc", e.target.files, {
                                                                    shouldValidate: true,
                                                                });
                                                            },
                                                        })}
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex flex-col items-center space-y-1">
                                                            {watch("marriageCert")?.[0] &&
                                                                Array.from(watch("marriageCert") as FileList).map(
                                                                    (file: File) => (
                                                                        <span
                                                                            key={file.name}
                                                                            className="text-center text-sm"
                                                    ...
                                                    <Input
                                                        ...
                                                        {...register("marriageCert", {
                                                            onChange: e => {
                                                                ...
                                                                // Important: setValue to keep RHF in sync and trigger validation
                                                                setValue("marriageCert", e.target.files, {
                                                                    shouldValidate: true,
                                                                });
                                                            },
                                                        })}
                        ...
                        <div className="flex justify-center gap-2">
                            ...
                            <Button variant={"default"} disabled={isUploading} type="submit">
                                {/* Texto sempre presente, invisível durante loading */}
                                <span className={isUploading ? "invisible" : "visible"}>Salvar</span>
