...
import { RequestActionError, deleteVisitRequest } from "@/services/adminRequestsService";
...
export async function DELETE(request: NextRequest, context: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        return NextResponse.json({ message: "Solicitação de visita deletada com sucesso" });
    } catch (error) {
