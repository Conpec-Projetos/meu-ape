        ...
        <div className="relative flex min-h-screen flex-col items-center justify-center bg-gray-100 dark:bg-gray-900">
            ...
            <div className="relative w-full max-w-4xl p-20">
                ...
                <div className="relative z-10 text-center pb-20">
                    <h2 className="text-8xl font-thin tracking-[0.3em] text-black">meu apê</h2>
                </div>

                <Card className="bg-white/70 dark:bg-black/30 backdrop-blur-md rounded-2xl border border-white/20 shadow-lg">
                            ...
                            <div className="flex flex-col gap-8">
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        id="email"
                                        type="email"
                                        className="bg-white rounded-lg border-gray-300 h-12" 
