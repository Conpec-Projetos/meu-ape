            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        >
                            <h3 className="font-semibold text-blue-900">Novo Empreendimento</h3>
                            <p className="text-sm text-blue-700">Cadastrar um novo empreendimento</p>
                        </Link>
                        ...
                        >
                            <h3 className="font-semibold text-green-900">Ver Empreendimentos</h3>
                            <p className="text-sm text-green-700">Listar todos os empreendimentos</p>
                        </Link>
                    </CardContent>
                </Card>
