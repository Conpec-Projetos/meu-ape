  ...
  return (
    <main className="min-h-screen w-full bg-white flex flex-col items-center gap-12 px-4 py-6">
      ...
      <div className="flex flex-col lg:flex-row items-center w-full max-w-7xl gap-8">
        ...
        <div className="w-full flex flex-col justify-center items-center">
          ...
          <div className="w-full bg-secondary rounded-lg flex flex-col p-4">
            <div className="w-fit px-3 py-1 border border-white rounded-4xl bg-primary text-white font-bold mb-4">Especificações</div>
            ...
            <span className='w-fit py-1 font-bold border-1 rounded-xl mt-15 text-white px-4 border-white bg-primary'> Descrição do imóvel</span>
        ...
        <div className="w-full lg:w-2/5 flex flex-col gap-4 h-fit justify-center items-center bg-secondary rounded-xl p-4">
          ...
          <button className={`h-10 w-10 rounded-full ml-auto flex mb-auto justify-center items-center bg-white transition-colors duration-400 ${favorite ? "border-2 border-primary" : "border border-transparent"}`}
          ...
          <button className="rounded-xl py-2 px-4 w-[40%] lg:w-[80%]  bg-primary text-white font-semibold">A partir de R$XXX,XX</button>
          <button className="rounded-xl py-3 w-[40%] lg:w-[80%] bg-primary text-white font-bold mt-4">Reserva</button>
          <button className="rounded-xl py-2 w-[30%] lg:w-[70%] bg-primary text-white font-semibold mt-2">Visita</button>
      ...
      <div className="w-full max-w-5xl flex flex-row aspect-video bg-secondary rounded-lg relative">
        ...
        <div className='absolute inset-0 flex justify-between items-end p-2'>
          ...
          <div className='h-12 w-7 bg-secondary rounded-sm flex flex-col justify-center items-center relative'>
            <button className='h-1/2 w-full flex justify-center items-center text-xl font-bold text-primary'>+</button>
            <div className='w-[80%] h-0.5 rounded-full opacity-30 absolute top-1/2 bg-black'></div>
            <button className='h-1/2 w-full flex justify-center items-center text-2xl font-bold text-primary'>-</button>
          </div>
        </div>
      </div>
      ...
      <div className="w-full h-auto max-w-5xl bg-secondary rounded-lg flex flex-col sm:flex-row justify-evenly items-center gap-4 relative p-4">
        <span className='absolute top-3 left-5 bg-primary text-white px-4 py-1 rounded-xl border border-white font-medium'>Imóveis relevantes</span>
