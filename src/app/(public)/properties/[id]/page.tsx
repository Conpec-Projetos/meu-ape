...
const mockProperty: Property = {
  ...
  description: "Um empreendimento magnífico com muito a oferecer. Vistas deslumbrantes, lazer completo e a tranquilidade que você sempre sonhou.",
  ...
  searchableUnitFeats: { minPrice: 500000, maxPrice: 1200000, sizes: [60, 70, 80], bedrooms: [1, 2, 3], baths: [1, 2], garages: [1, 2], minSize: 60, maxSize: 80 },
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div>
                ...
                <ul className="grid grid-cols-2 gap-2">
                    {property.features.map(feat => <li key={feat} className="flex items-center gap-2 text-sm"><div className="w-1.5 h-1.5 rounded-full bg-primary"></div>{feat}</li>)}
                </ul>
            </div>
          ...
          <div className="lg:col-span-2">
            {(selectedBlock && selectedCategory) ? (
                ...
                <div className="flex items-center justify-center h-full bg-secondary/30 rounded-xl p-8">
                    <p className="text-muted-foreground text-center">Selecione um bloco e uma tipologia para ver as unidades disponíveis.</p>
                </div>
            )}
          </div>
        </div>
