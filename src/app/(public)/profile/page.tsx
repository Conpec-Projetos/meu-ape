                ...
                {activeTab === "documentos" && (
                    <div className="flex flex-col gap-5 pl-20 items-start justify-center h-full w-full">
                        <div className="relative">
                            ...
                            <h2 className="cursor-pointer absolute text-gray-600 text-[12px] bottom-[14px] right-6">
                                RG ou CIN
                            </h2>
                        </div>
                        <div className="relative">
                            ...
                            <DownloadIcon className="cursor-pointer ml-10 p-6 pt-1 text-gray-400 border-gray-400 border-3 border-dashed rounded-[10px] h-27 w-27" />
                            <h2 className="cursor-pointer absolute text-gray-600 text-[12px] bottom-[5px] left-[50px]">
                                Comprovante de<span className="flex justify-center">endereço</span>
                            </h2>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <DownloadIcon className="cursor-pointer ml-10 p-6 pt-1 text-gray-400 border-gray-400 border-3 border-dashed rounded-[10px] h-27 w-27" />
                            <h2 className="cursor-pointer absolute text-gray-600 text-[12px] bottom-[5px] left-[50px]">
                                Comprovante de <span className="flex justify-center">renda</span>
                            </h2>
                        </div>
                        <div className="relative ">
                            <h1 className="pb-1 text-2xl text-[#4D4D4D]">Certidão de casamento:</h1>
                            <DownloadIcon className="cursor-pointer ml-10 p-6 pt-1 text-gray-400 border-gray-400 border-3 border-dashed rounded-[10px] h-27 w-27" />
                            <h2 className="cursor-pointer   absolute text-gray-600 text-[12px] bottom-[5px] left-[65px]">
                                Certidão de<span className="flex justify-center">casamento</span>
                            </h2>
                        </div>
                        <div className="flex items-center justify-center w-screen h-auto pb-2">
                            <Button className="bg-black w-[100px] hover:bg-blend-color-burn cursor-pointer ">
                                Salvar
                            </Button>
                        </div>
                    </div>
